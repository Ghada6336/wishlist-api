...
urlpatterns = [
    ...
    path('register/', secondview.Register.as_view(), name="api-register"),

    path('api/', secondview.ItemListView.as_view(), name="api-list"),
    path('api/<int:item_id>/', secondview.ItemDetailView.as_view(), name="api-detail"),
